...
/**
 * 类 AutoCompleteAdapter 自动联想补全输入框
 * 
 * @author xinyi
 * 
 * @since 1.0.0
...
public class AutoCompleteAdapter< T > extends BaseAdapter implements Filterable
{
	 ...
	 */
	public static AutoCompleteAdapter< CharSequence > createFromResource(
			Context context, int textArrayResId, int textViewResId )
	{
		CharSequence[] strings = context.getResources().getTextArray(
				textArrayResId );
		return new AutoCompleteAdapter< CharSequence >( context, textViewResId,
				strings );
	}
